...
public class DFRBagExpansionTerms extends ExpansionTerms {
	...
	* @param _documentIndex DocumentIndex to use for finding statistics about documents
 	*/
	public DFRBagExpansionTerms(CollectionStatistics collStats, Lexicon<String> _lexicon, PostingIndex<BitIndexPointer> _directIndex, DocumentIndex _documentIndex) {
