...
#sys.path.append('/var/www/otalo')
sys.path.append('/var/www')
#sys.path.append('/home/siddhartha/workspace/ao_server')
sys.path.append('/usr/local/freeswitch/scripts/AO')
sys.path.append('/usr/local/freeswitch/scripts/AO/outbound')
sys.path.append('/usr/local/freeswitch/scripts/AO/scripts')
sys.path.append('/usr/bin/ad_digest')

os.environ['DJANGO_SETTINGS_MODULE'] = 'iiitd.settings'
